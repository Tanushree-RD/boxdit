        ...
        {insights.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              className="group relative flex h-full min-h-[220px] sm:min-h-[230px] lg:min-h-[240px] flex-col justify-between overflow-hidden rounded-2xl border border-white/[0.07] bg-white/[0.015] p-7 sm:p-8 transition-all duration-200 hover:border-white/[0.14] hover:bg-white/[0.028]"
            >
              <div>
                {/* Header */}
                ...
                <div className="my-6 flex items-center gap-3.5">
                  ...
                  <div className="min-w-0 flex-1">
                    <p
                      title={item.value}
                      className="text-lg sm:text-xl font-bold text-white tracking-tight leading-snug truncate tabular-nums group-hover:text-zinc-200 transition-colors"
                    >
                      {item.value}
                    </p>
                    <p
