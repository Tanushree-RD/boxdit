      ...
      <div className="grid gap-6 md:grid-cols-3">
        {steps.map((step, i) => (
          <motion.div
            ...
            variants={fadeUp}
            custom={i + 2}
            className="group relative flex flex-col justify-between rounded-[22px] border border-white/[0.08] bg-[#0c0c0e]/70 p-8 sm:p-9 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-white/[0.18] hover:bg-[#121214]/80"
          >
            <div>
